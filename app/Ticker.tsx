export default function Ticker() {
  ...
  return (
    <div className="mb-10 overflow-hidden">
      ...
      "
      <div
        className=" flex gap-10 w-max py-1 whitespace-nowrap animate-[ticker_22s_linear_infinite]  border-2 border-[var(--border)] bg-[var(--ticker)]
      ...
      >
        ...
        {items.map((item, i) => (
          <div
            key={i}
            className="flex items-center gap-4 text-xl text-[var(--text-muted)] border-r border-[var(--border)]  px-2 py-2  tracking-wide "
          >
