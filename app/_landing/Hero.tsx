...
export default function Hero() {
  return (
    <section className="max-w-5xl mx-auto px-6 ">
      ...
      >
        {/* max-w-[1250px] mx-auto flex flex-col lg:flex-row items-center gap-20 */}

        {/* LEFT */}
        <div className="w-auto  min-w-0 flex flex-col gap-2 pt-[20px]">
          {/* Badge */}
          ...
          <h1 className="text-xl md:text-xl lg:text-5xl font-bold text-[var(--secondary-color)] leading-[1.5] opacity-0 animate-[fadeup_0.6s_ease_0.18s_forwards]">
            ...
            <em className="ml-3 text-[var(--primary)] italic">clear insight</em>
          </h1>
          ...
          <p className="text-[var(--text-muted)] leading-relaxed tracking-wide text-2xl  md:text-xl max-w-xl opacity-0 animate-[fadeup_0.6s_ease_0.3s_forwards]">
            Upload documents, images, or audio — Clarix extracts summaries, key
            insights, and action items in seconds.
          </p>
        ...
        {/* RIGHT */}
        <div className="w-auto  min-w-0 flex items-center mt-30">
          <ChatDemo />
        </div>
      </div>
    </section>
